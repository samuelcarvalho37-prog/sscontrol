...
export interface ActionAvailabilityData {
  ...
  estado?:
    "SEM_AGENDAMENTO" | "AGENDADA" | "EM_ALERTA" | "DISPONIVEL" | "ATRASADA";
...
export interface OperatorActionDetailData {
  ...
  execucao?: {
    ...
    modo_execucao_manutencao?:
      MaintenanceStartDecision | "COM_PARADA" | "SEM_PARADA";
  } | null;
...
export type MaintenanceStopMode =
  "OBRIGATORIA" | "DECISAO_EXECUTOR" | "SEM_PARADA";

export type MaintenanceStartDecision = "PARAR_EQUIPAMENTO" | "SEM_PARADA";
